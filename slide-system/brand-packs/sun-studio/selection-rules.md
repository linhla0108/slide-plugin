# SUN.STUDIO Selection Rules

- Use the canonical token stylesheet and bundled Proxima Nova fonts.
- Primary colors are orange `#FF5533`, blue `#3333FF`, warm paper `#FFFDF8`,
  and ink `#171717`.
