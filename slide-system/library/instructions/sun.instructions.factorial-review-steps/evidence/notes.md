# Evidence — factorial-review-steps

- Candidate ID: `sun.instructions.factorial-review-steps`
- Status: `staging`
...
- Shared-asset references across the item's SVG files: `14`.
