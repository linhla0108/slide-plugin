# Evidence — intro-explanation-layout

- Candidate ID: `sun.layout.intro-explanation-layout`
- Status: `staging`
- Source: `/Users/home/Documents/work-space/sun-riser-2026/input/SUN.STUDIO_-_Performance_Review_-_2025.pdf` (sha256 `9e18f2a0f48f979c...`)
- Slide or page: `4`
...
- Shared-asset references across the item's SVG files: `2`.
- Unique external image files: `1`.
