---
name: export-as-editable-pptx
description: Export an HTML slide deck to an editable PowerPoint presentation with native text, shapes, images, speaker notes, font handling, and capture validation. Use when the user asks to export or convert an HTML deck to PPTX while preserving editability.
---
