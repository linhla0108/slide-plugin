---
name: send-to-canva
description: Bundle a self-contained HTML design, publish it temporarily, and import it into Canva as an editable design with validation and fallback handling. Use when the user asks to send or export the current design to Canva.
---
