# Evidence - Guideline Icon Library

- Candidate ID: `sun.asset.guideline-icon-library`
...
- Source raster reference: `tmp/pdfs/guideline-presentation-sun/page-1.png`
...
- Text mode: `native-text` with `17` text/tspan records.
- Tag counts: `{"clipPath": 3, "defs": 1, "g": 5, "path": 880, "svg": 1, "text": 4, "tspan": 13}`.
- References: `3`; warnings: `none`.

## Extraction method

Exact full-page SVG plus a currentColor sizing contract for reusable icon instances.
