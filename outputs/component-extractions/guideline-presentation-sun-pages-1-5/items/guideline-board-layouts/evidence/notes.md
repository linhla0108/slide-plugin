# Evidence - Guideline Board Layouts

- Candidate ID: `sun.component.guideline-board-layouts`
...
- Source raster reference: `tmp/pdfs/guideline-presentation-sun/page-4.png`
...
- Text mode: `native-text` with `101` text/tspan records.
- Tag counts: `{"clipPath": 20, "defs": 1, "g": 25, "path": 111, "svg": 1, "text": 23, "tspan": 78}`.
- References: `20`; warnings: `none`.

## Extraction method

Exact full-page SVG plus editable table-board and radial-board layout contracts.
...
- Base64 data-image references replaced: `0`.
- Unique external image files: `0`.
