# Evidence - Guideline Card Variants

- Candidate ID: `sun.component.guideline-card-variants`
...
- Source raster reference: `tmp/pdfs/guideline-presentation-sun/page-2.png`
...
- Text mode: `native-text` with `78` text/tspan records.
- Tag counts: `{"clipPath": 22, "defs": 1, "g": 30, "image": 11, "mask": 2, "path": 129, "rect": 2, "svg": 1, "text": 21, "tspan": 57, "use": 2}`.
- References: `37`; warnings: `none`.

## Extraction method

Exact full-page SVG plus semantic HTML and scoped CSS for level, profile, and metric card families.
...
- Unique external image files: `11`.
